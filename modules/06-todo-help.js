...
(function (global) {
  ...
  function renderHelp(state, doc, validation) {
    ...
    var helpHtml = ''
      ...
      + '<li>Copia <code style="background:#1c222b;padding:2px 6px;border-radius:4px;">drop-in-task-manager.html</code> a la raíz del proyecto</li>'
